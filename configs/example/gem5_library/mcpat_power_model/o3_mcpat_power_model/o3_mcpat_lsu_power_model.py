...
class O3McPATLsuPower(McPATPowerModel):
    # avoid the use of default values
    def __init__(
        self, cpu: BaseO3CPU, act_energies, pipeline_act_factor, lsu_act_factor
    ):
        super().__init__(cpu, act_energies)
        self.name = "O3McPATLsuPower"
