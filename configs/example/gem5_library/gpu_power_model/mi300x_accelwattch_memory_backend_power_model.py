...
class MI300XAccelwattchMemoryBackendPower(AccelwattchBaseMemoryPowerModel):
    def __init__(
        ...
        self.name = "MI300XAccelwattchMemoryBackendPower"
    ...
    def mem_refresh_overhead(self) -> float:
        execTime = self.get_stat("shaderActiveTicks") / 1e12
