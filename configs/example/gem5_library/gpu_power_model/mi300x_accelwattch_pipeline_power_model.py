...
class MI300XAccelwattchPipelinePower(AccelwattchBasePowerModel):
    def __init__(self, gpu: Shader, act_energies, scaling_factors, interval):
        ...
        self.name = "MI300XAccelwattchPipelinePower"
        self._num_units = 4.0
    ...
    def pipeline_energy(self) -> float:
        ...
        rtp_pipeline_coe = (
            gpu_duty_cycle * self.get_total_cycles() * self.get_number_of_cus()
        )
